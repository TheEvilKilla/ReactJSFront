...
function NavBar() {
    const buttonsContent = [{ text: 'Restaurants', icon: restaurant, href: '/establishments/restaurants' },
    { text: 'Hotels', icon: hotel, href: '/establishments/hotels'},
    { text: 'Vets', icon: vet, href: '/establishments/vets' },
